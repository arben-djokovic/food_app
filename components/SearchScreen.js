...
export default function SearchScreen({navigation}) {
  ...
  return (<SafeAreaView style={styles.androidSafe}>
      ...
      <Ionicons onPress={()=>{navigation.goBack()}} name="chevron-back-outline" size={24} style={{marginTop: 5, marginRight: 10}} color="black" />
          <TextInput onChangeText={(e)=>{setInputText(e)}} placeholder='Unesite ime proizvoda' style={{padding: 5, margin: 5, fontSize: 18, borderBottomWidth: 1, width: 90+'%'}} />
      </View>
      <ScrollView  style={{ backgroundColor: '#f3f3f3', paddingHorizontal: 10, maxHeight: Dimensions.get('window').height - 73 }}>
